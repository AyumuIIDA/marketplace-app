...
import type { UpdateListingWithHumanSignatureOperation } from "../../../app/workflows/index.js";
...
export type UpdateListingToolDeps = {
  updateListingWithHumanSignatureWorkflow: UpdateListingWithHumanSignatureOperation;
};

export class UpdateListingTool implements McpTool {
  readonly name = "update_listing";
  readonly inputSchema = updateListingToolInputSchema.shape;

  constructor(private readonly deps: UpdateListingToolDeps) {}
