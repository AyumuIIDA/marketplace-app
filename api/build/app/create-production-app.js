...
import { CreateAgentUseCase, DisableAgentUseCase, ListAgentsUseCase, SuggestListingFieldsUseCase, SuggestPriceUseCase, SuggestReviewUseCase, } from "../modules/agents/index.js";
import { DrizzleAgentRepository, DeterministicAiAssistant, } from "../modules/agents/infrastructure/index.js";
import { GetCurrentUserUseCase, UpsertCurrentUserUseCase, } from "../modules/identity/index.js";
import { DrizzleUserRepository } from "../modules/identity/infrastructure/index.js";
import { CreateListingUseCase, GetListingUseCase, HideListingUseCase, ListingPublicationService, ListingPurchaseService, SearchListingsUseCase, UpdateDraftListingUseCase, } from "../modules/listings/index.js";
import { DrizzleListingRepository } from "../modules/listings/infrastructure/index.js";
import { HideMessageUseCase, ListMessagesUseCase, SendMessageUseCase, } from "../modules/messages/index.js";
import { DrizzleMessageRepository } from "../modules/messages/infrastructure/index.js";
import { GetOrderUseCase, ListOrdersUseCase, MarkOrderReceivedUseCase, MarkOrderShippedUseCase, OrderFulfillmentService, } from "../modules/orders/index.js";
import { DrizzleOrderRepository } from "../modules/orders/infrastructure/index.js";
import { CreateReviewUseCase, ListReviewsUseCase, ReviewSubmissionService, } from "../modules/reviews/index.js";
import { DrizzleReviewRepository } from "../modules/reviews/infrastructure/index.js";
import { HumanSignatureApplicationService, HumanSignatureCreator, } from "../modules/signatures/index.js";
import { JwsHumanSignatureSigner, WorldIdVerifierClient, } from "../modules/signatures/infrastructure/index.js";
import { CreateListingDraftTool, CreateReviewTool, PublishListingTool, PurchaseItemTool, SearchListingsTool, SendMessageTool, SubmitReviewTool, SuggestListingFieldsTool, SuggestPriceTool, SuggestReviewTool, UpdateListingTool, } from "../modules/mcp/index.js";
import { CreateReviewWorkflow, ListOrderMessagesWorkflow, PublishListingWithHumanSignatureWorkflow, PurchaseItemWorkflow, SendOrderMessageWorkflow, SubmitReviewWithHumanSignatureWorkflow, UpdateListingWithHumanSignatureWorkflow, } from "./workflows/index.js";
import { DrizzleHumanSignatureWorkflowTransaction, DrizzleMessageWorkflowTransaction, DrizzlePurchaseWorkflowTransaction, DrizzleReviewWorkflowTransaction, } from "./workflows/infrastructure.js";
import { createApiApp } from "./create-app.js";
export function createProductionApp(db = createDb()) {
